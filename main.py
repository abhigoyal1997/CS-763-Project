...
def parse_args():
	...
	parser_train.add_argument('-mc','--model-config',dest='model_config',default='vqa.config')
	parser_train.add_argument('-c','--comment',dest='comment',default=None)
	parser_train.add_argument('-d','--data-root',dest='data_root',default='data/abstract_binary/train')
	...
	parser_test.add_argument('-d','--data-root',dest='data_root',default='data/abstract_binary/val')
